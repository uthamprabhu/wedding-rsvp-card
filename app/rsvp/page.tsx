...
const scrollReveal = {
  hidden: { opacity: 0, y: 26, filter: 'blur(4px)' }, // Reduced blur for performance
    ...
    <main className="rsvp-page">
      ...
      <motion.div className="rsvp-wrap" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.4 }}>
        ...
        <form ref={formRef} className="rsvp-form" onSubmit={handleSubmit} noValidate>
          <motion.section className="rsvp-section" aria-labelledby="guest-heading" variants={scrollReveal} initial="hidden" whileInView="visible" viewport={{ once: isMobile, amount: .22 }} transition={{ duration: isMobile ? 0.5 : .7, ease: [0.22, 1, 0.36, 1] }}>
          ...
          <motion.section className="rsvp-section" aria-labelledby="party-heading" variants={scrollReveal} initial="hidden" whileInView="visible" viewport={{ once: isMobile, amount: .22 }} transition={{ duration: isMobile ? 0.5 : .7, ease: [0.22, 1, 0.36, 1] }}>
